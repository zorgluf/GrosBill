...
class Board():
    def __init__(self):
        ...
        self._played_cards = [ { PlayerId.PLAYER1: Deck(), PlayerId.PLAYER2: Deck() } for _ in range(NB_STONES) ]
...
ALL_CARDS = [ Card(i, c) for i in range(1, 9) for c in Color ]
