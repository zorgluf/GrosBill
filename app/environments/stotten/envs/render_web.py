...
class RenderWeb:
    ...
    @ui.refreshable
    def _get_card_element(self, card: Card, add_star = False):
    ...
    @ui.refreshable
    def _gui_board(self, env, callback, suggested_action = None):
        board = env.board
    ...
    @ui.refreshable
    def _gui_hand(self, env: SchottenTottenEnv, callback, suggested_action = None):
    ...
    def init_web(self, env: SchottenTottenEnv, callback = None):
        ...
        with ui.column().classes("gap-0"):
            ...
            self._gui_hand(env, callback)

    def render_web(self, env: SchottenTottenEnv, callback = None, suggested_action = None, **kwargs):
        self._gui_board.refresh(env, callback, suggested_action)
        self._gui_hand.refresh(env, callback, suggested_action)
